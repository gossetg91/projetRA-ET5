...
public class VButtonCommunityChestCard : MonoBehaviour
{
    public string cards_path = @"Textures\Cards\Front\CommunityChest\";
    ...
    void Start()
    {
        ...
        // Init button
        vbBtnObj = GameObject.Find("VButtonCommunityChestCard");
